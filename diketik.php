<?php
///////////////////////////////////////////
///////CREATED BY AAAAAAAAAAAAAAAA////////
//////www.facebook.com/AAAAAAAAAAA///////
/////https://github.com/aaaaaaaaaa//////
///////////////////////////////////////

include 'tri_jebol.php';

$tri = new tri();
$imei = "868880043302499";
echo "Masukkan No Telepone Sira : ";
$msisdn = trim(fgets(STDIN));
$otp = $tri->request_otp($msisdn,$imei);
echo $otp[1] . "\r\n";
echo "Masukkan OTP Sing SMS : ";
